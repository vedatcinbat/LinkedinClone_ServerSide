...
namespace JobNet.CoreApi.Migrations
{
    ...
    [Migration("20240222064420_FollowersAndFollowingWillStoreUserType")]
    partial class FollowersAndFollowingWillStoreUserType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobNet.CoreApi.Data.Entities.Follow", b =>
                {
                    ...
                    b.Property<int>("FollowerUserUserId")
                        .HasColumnType("int");

                    b.Property<int>("FollowingId")
                        .HasColumnType("int");

                    b.Property<int>("FollowingUserUserId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("FollowerUserUserId");

                    b.HasIndex("FollowingUserUserId");
            ...
            modelBuilder.Entity("JobNet.CoreApi.Data.Entities.Follow", b =>
                {
                    b.HasOne("JobNet.CoreApi.Data.Entities.User", "FollowerUser")
                        .WithMany()
                        .HasForeignKey("FollowerUserUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobNet.CoreApi.Data.Entities.User", "FollowingUser")
                        .WithMany()
                        .HasForeignKey("FollowingUserUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
